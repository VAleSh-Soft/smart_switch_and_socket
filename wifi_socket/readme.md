...
***Примечание**: не каждое реле модуля может иметь собственную локальную кнопку на модуле. В этом случае такое реле может управляться с помощью Web-интерфейса или с помощью WiFi-выключателя, настроенного на эту кнопку.*
